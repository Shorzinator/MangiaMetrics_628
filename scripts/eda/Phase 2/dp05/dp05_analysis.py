...
def create_chloropleth(gis_data, demographic_data, pa_shapefile, factor, filenames):
    ...
    # Show the map
    output_path = os.path.join(get_path_from_root("results", "eda", "Phase 2", "DP05_analysis"),
                               f"dp05_{filenames}.png")
...
def main():
    ...
    chosen_factors = {
        "Sex and Age - Total population - 25 to 34 years": "Sex&Age_TotPop_25to34",
        "Sex and Age - Total population - Median age (years)": "Sex&Age_TotPop_MedAge",
        "Race - Total population - One race - White": "Rac_TotPop_OneRac_Whi",
        "Sex and Age - Total population": "Sex&Age_TotPop",
        "Hispanic or Latino and Race - Total housing units": "HisOrLat&Rac_TotPop"
    }
